...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojnylondonmujer.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj Ny London</h1><br>
            <p class="price"><strong>Lps. 950 <span></span></strong></p><br>
...
<button onclick="addToCart('Reloj Ny London de mujer (plata)', 950, document.getElementById('quantity118').value)" class="wishlist">Añadir al carrito</button> <label for="quantity118">Cantidad: </label>
        <input type="number" id="quantity118" min="1" max="5" value="1"><br>
        <br>
