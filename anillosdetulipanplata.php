...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillosdetulipanplata.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de tulipan</h1><br>
...
<button onclick="addToCart('Anillo de tulipan (plata)', 1800, document.getElementById('quantity98').value)" class="wishlist">Añadir al carrito</button> <label for="quantity98">Cantidad: </label>
        <input type="number" id="quantity98" min="1" max="3" value="1"><br>
        <br>
