...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulserasdechaquiraojo1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulseras de Ojos</h1><br>
            <p class="price"><strong>Lps. 65 c/u <span></span></strong></p><br>
          ...
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de ojo (chaquira)', 65, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
