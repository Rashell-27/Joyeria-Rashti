...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillomariposasplata.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de mariposas</h1><br>
...
<button onclick="addToCart('Anillo de mariposa (plata)', 1500, document.getElementById('quantity97').value)" class="wishlist">Añadir al carrito</button> <label for="quantity97">Cantidad: </label>
