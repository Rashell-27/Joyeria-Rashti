...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulseradecoloresace1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details">
            <h1>Pulsera de Cristales</h1><br>
            <p class="price"><strong>Lps. 135 <span></span></strong></p><br>
          ...
          <button onclick="addToCart('Pulsera de cristales (oro)', 135, document.getElementById('quantity44').value)" class="wishlist">Añadir al carrito</button> <label for="quantity44">Cantidad: </label>
        <input type="number" id="quantity44" min="1" max="10" value="1"><br>
        <br>
