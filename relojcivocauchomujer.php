...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojcivocauchomujer.jpg" alt="Anillo de compromiso"  class="active">
        ...
        <div class="product-details" style="width: 30%; height: auto;">
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
           ...
           <p><strong>Colores disponibles:</strong> Negro, Azul, Verde, Rosa y Blanco.</p><br>
           <br>
          <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
<button onclick="addToCart('Reloj civo de mujer (caucho)', 550, document.getElementById('quantity121').value)" class="wishlist">Añadir al carrito</button> <label for="quantity121">Cantidad: </label>
        <input type="number" id="quantity121" min="1" max="5" value="1"><br>
        <br>
