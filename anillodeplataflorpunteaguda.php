...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodeplataflorpunteaguda.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de plata</h1><br>
...
<button onclick="addToCart('Anillo de plata', 1800, document.getElementById('quantity92').value)" class="wishlist">Añadir al carrito</button> <label for="quantity92">Cantidad: </label>
