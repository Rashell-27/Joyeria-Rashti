...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anilloconojo.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo con ojo</h1><br>
            <p class="price"><strong>Lps. 70 <span></span></strong></p><br>
...
<button onclick="addToCart('Anillo con ojo (perlas)', 70, document.getElementById('quantity107').value)" class="wishlist">Añadir al carrito</button> <label for="quantity107">Cantidad: </label>
        <input type="number" id="quantity107" min="1" max="3" value="1"><br>
        <br>
