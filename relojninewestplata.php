...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojninewestplata.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj nine west</h1><br>
            <p class="price"><strong>Lps. 1,225 <span></span></strong></p><br>
...
<button onclick="addToCart('Reloj nine west (plata)', 1225, document.getElementById('quantity116').value)" class="wishlist">Añadir al carrito</button> <label for="quantity116">Cantidad: </label>
        <input type="number" id="quantity116" min="1" max="5" value="1"><br>
        <br>
