...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/gargantillademariposaper.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details" style="width: 35%;
            height: 110%">
            <h1>Gargantilla con dije de mariposa</h1><br>
            <p class="price"><strong>Lps. 200 <span></span></strong></p><br>
            ...
            <p><strong>Colores de perlas disponibles:</strong> Rojo, Azul, Café, Negro, Naranja, Rosa, Verde, Morado, Amarillo y Blanco.</p><br>
             <p><strong>Colores de mariposas disponibles:</strong> Rojo, Azul, Rosa, Verde, Morado, y Blanco.</p><br>
