...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/gargantilladediamantess.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Gargantilla de diamantes</h1><br>
            <p class="price"><strong>Lps. 2,350 <span></span></strong></p><br>
...
<br>
    <button onclick="addToCart('Gargantilla de diamantes (oro)', 2350, document.getElementById('quantity12').value)" class="wishlist">Añadir al carrito</button> <label for="quantity12">Cantidad: </label>
        <input type="number" id="quantity12" min="1" max="10" value="1"><br>
        <br>      
