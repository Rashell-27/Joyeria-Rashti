...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodecorazonycorona.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de Corazón y Corona</h1><br>
            <p class="price"><strong>Lps. 1,500 <span></span></strong></p><br>
            
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Tallas disponibles:</strong> 6, 7, 8, 9 y 10</p><br>
...
<button onclick="addToCart('Anillo de Corazón y Corona (oro)', 1500, document.getElementById('quantity86').value)" class="wishlist">Añadir al carrito</button> <label for="quantity86">Cantidad: </label>
        <input type="number" id="quantity86" min="1" max="3" value="1"><br>
        <br>
