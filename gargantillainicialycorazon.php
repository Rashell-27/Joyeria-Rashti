...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/gargantillainicialycorazon.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details" style="width: 35%;
            height: 100%">
            <h1>Gargantilla de corazón</h1><br>
   ...
   <p><strong>Colores de corazón disponibles:</strong> Rojo, Azul, Blanco y Negro.</p><br> 
