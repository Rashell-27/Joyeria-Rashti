...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodeplatacorona.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo con corona</h1><br>
...
<button onclick="addToCart('Anillo con corona (plata)', 2000, document.getElementById('quantity92').value)" class="wishlist">Añadir al carrito</button> <label for="quantity92">Cantidad: </label>
