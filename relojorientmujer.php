...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojorientmujer.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj Orient</h1><br>
...
<button onclick="addToCart('Reloj orient de mujer (oro)', 1200, document.getElementById('quantity112').value)" class="wishlist">Añadir al carrito</button> <label for="quantity112">Cantidad: </label>
        <input type="number" id="quantity112" min="1" max="5" value="1"><br>
        <br>
