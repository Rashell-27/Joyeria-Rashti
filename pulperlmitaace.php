...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulperlmitace1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
        ...
        <div class="product-details">
          ...
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de Decorada (mitad perla)(oro)', 120, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
