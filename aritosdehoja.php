...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/aritosdehoja.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Aritos de hoja</h1><br>
            <p class="price"><strong>Lps. 2300 <span></span></strong></p><br>
          ...
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Aritos de Hoja (oro)', 2300, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
