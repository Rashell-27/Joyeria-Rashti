...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojsmarwatchmujer.jpg" width="400" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Smartwatch cuadrado</h1><br>
...
<button onclick="addToCart('Smart Watch de mujer cuadrado (caucho)', 2100, document.getElementById('quantity125').value)" class="wishlist">Añadir al carrito</button> <label for="quantity125">Cantidad: </label>
        <input type="number" id="quantity125" min="1" max="5" value="1"><br>
        <br>
