...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodeplataconcorona.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de corona</h1><br>
            <p class="price"><strong>Lps. 2,800 <span></span></strong></p><br>
...
<button onclick="addToCart('Anillo de corona (plata)', 2800, document.getElementById('quantity94').value)" class="wishlist">Añadir al carrito</button> <label for="quantity94">Cantidad: </label>
        <input type="number" id="quantity94" min="1" max="3" value="1"><br>
        <br>
