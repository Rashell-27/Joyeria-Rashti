...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/aritosdelazooro.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Aritos de lazo</h1><br>
          ...
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Aritos de lazo (oro)', 1700, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
