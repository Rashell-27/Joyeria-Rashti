...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulcorazonescolorhilo1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
        ...
        <div class="product-details" style="width: 30%; height: auto;">
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Colores de corazones disponibles:</strong> Dorado.</p><br>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de Corazón (hilo)', 60, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
