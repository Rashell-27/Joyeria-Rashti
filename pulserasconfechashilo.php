...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulserasconfechashilos.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulseras con fechas</h1><br>
            <p class="price"><strong>Lps. 60 c/u <span></span></strong></p><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Colores de corazones disponibles:</strong> Rojo, Azul, Amarillo, Naranja, Rosa y Verde.</p><br>
          <br>
          <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
            <button onclick="addToCart('Pulsera con fecha (hilo)', 60, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
