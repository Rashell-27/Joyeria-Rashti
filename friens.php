...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/friends1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div  class="product-details" style="width: 30%; height: auto;">
            <h1>Pulsera con frases y/o nombres </h1><br>
            <p class="price"><strong>Lps. 90 c/u <span></span></strong></p><br>
          ...
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera con frases y/o nombres (chaquiras)', 90, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
