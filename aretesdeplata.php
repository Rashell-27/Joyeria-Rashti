...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/aretesdeplata.jfif" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Aretes de plata</h1><br>
            <p class="price"><strong>Lps. 2,000 <span></span></strong></p><br>
            
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Tallas disponibles:</strong> 20mm, 25mm, 30mm, 40mm y 50mm. </p><br>
                      <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
            <button onclick="addToCart('Aretes de plata (oro)', 2000, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
