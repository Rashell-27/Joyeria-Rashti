...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anilloperlas.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de perlas</h1><br>
...
<button onclick="addToCart('Anillo sencillo (perlas)', 60, document.getElementById('quantity100').value)" class="wishlist">Añadir al carrito</button> <label for="quantity100">Cantidad: </label>
        <input type="number" id="quantity100" min="1" max="3" value="1"><br>
        <br>
