...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/gargantíadeflores1.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details" style="margin: auto; padding: 25PX;">
            <h1>Gargantilla de flores</h1><br>
...
<br>
<button onclick="addToCart('Gargantilla de flores (oro)', 350, document.getElementById('quantity5').value)" class="wishlist">Añadir al carrito</button> <label for="quantity5">Cantidad: </label>
        <input type="number" id="quantity5" min="1" max="10" value="1"><br>
        <br>
