...
<section class="product-page" style="padding: 380px;">
        <div class="product-images">
            <img src="imagenes/gargantíadeperlas.jfif" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details" style=" width: 35%; height: 90%">
            <h1>Gargantilla de perlas</h1><br>
            <p class="price"><strong>Lps. 550 <span></span></strong></p><br>
            <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Medidas disponibles:</strong> 35 cm de largo.</p><br>
            <p><strong>Colores de perlas disponibles:</strong> Rojo, Morado, Azul, Verde, Negro y Blanco.</p><br>
...
<br>
<button onclick="addToCart('Gargantilla de perlas (oro)', 550, document.getElementById('quantity4').value)" class="wishlist">Añadir al carrito</button> <label for="quantity4">Cantidad: </label>
        <input type="number" id="quantity4" min="1" max="10" value="1"><br>
        <br>
