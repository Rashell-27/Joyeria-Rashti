...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodediamantes.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
...
<button onclick="addToCart('Anillo de diamantes (oro)', 1800, document.getElementById('quantity92').value)" class="wishlist">Añadir al carrito</button> <label for="quantity92">Cantidad: </label>
