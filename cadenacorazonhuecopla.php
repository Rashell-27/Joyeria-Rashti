...
<br>
 <button onclick="addToCart('Cadena de corazón hueco (plata)', 350, document.getElementById('quantity20').value)" class="wishlist">Añadir al carrito</button> <label for="quantity20">Cantidad: </label>
        <input type="number" id="quantity20" min="1" max="10" value="1"><br>
        <br>
