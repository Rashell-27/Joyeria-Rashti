...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulserablanca1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details">
            <h1>Pulsera Sencilla</h1><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Colores disponibles:</strong> Rojo, Azul, Café, Negro, Naranja, Rosa, Verde, Morado, Amarillo y Blanco.</p><br>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera Sencilla (perlas)', 50, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
