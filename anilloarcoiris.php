...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anilloarcoiris.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de arcoiris</h1><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
           ...
           <p><strong>Colores de perlas disponibles:</strong> Rojo, Azul, Verde, Amarillo, Naranja, Morado, Blanco y Negro.</p><br>
           <br>
          <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
<button onclick="addToCart('Anillo de arcoiris (perlas)', 60, document.getElementById('quantity103').value)" class="wishlist">Añadir al carrito</button> <label for="quantity103">Cantidad: </label>
        <input type="number" id="quantity103" min="1" max="3" value="1"><br>
        <br>
