...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collardefimoyperlas.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details"  style="width: 35%;
            height: 120%">
            <h1>Collar de perlas decorado</h1><br>
            <p class="price"><strong>Lps. 180 <span></span></strong></p><br>
            ...
            <p><strong>Normalmente este collar se hace con fimos de todos los colores, pero si te interesa añadir algunos o combinarlos, aqui te dejamos los colores disponibles.</strong></p><br>
            <p><strong>Colores de fimos disponibles:</strong> Rojo, Naranja Amarillo, Verde, Azul, Morado, Rosa, Blanco, Café y Negro.</p><br>
