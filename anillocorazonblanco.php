...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillocorazonblanco.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de corazón</h1><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
           ...
           <p><strong>Colores de corazón disponibles:</strong> Rojo, Azul, Verde, Amarillo, Blanco y Negro.</p><br>
           <br>
          <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
<button onclick="addToCart('Anillo de corazón (perlas)', 90, document.getElementById('quantity105').value)" class="wishlist">Añadir al carrito</button> <label for="quantity105">Cantidad: </label>
        <input type="number" id="quantity105" min="1" max="3" value="1"><br>
        <br>
