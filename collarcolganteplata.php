...
<br>
<button onclick="addToCart('Gargantilla de joyas colgantes (plata)', 510, document.getElementById('quantity21').value)" class="wishlist">Añadir al carrito</button> <label for="quantity21">Cantidad: </label>
        <input type="number" id="quantity21" min="1" max="10" value="1"><br>
        <br>
