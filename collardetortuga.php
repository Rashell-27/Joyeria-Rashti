...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collardetortuga.jfif" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Collar con dije de tortuga</h1><br>
...
<br>
<button onclick="addToCart('Collar con dije de tortuga (plata)', 800, document.getElementById('quantity24').value)" class="wishlist">Añadir al carrito</button> <label for="quantity24">Cantidad: </label>
        <input type="number" id="quantity24" min="1" max="10" value="1"><br>
        <br>
