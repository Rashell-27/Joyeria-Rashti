...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodelazoperl.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de lazo</h1><br>
...
<button onclick="addToCart('Anillo de lazo (perlas)', 85, document.getElementById('quantity102').value)" class="wishlist">Añadir al carrito</button> <label for="quantity102">Cantidad: </label>
        <input type="number" id="quantity102" min="1" max="3" value="1"><br>
        <br>
