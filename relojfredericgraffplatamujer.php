...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojfredericgraffplatamujer.jpg" width="300"alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj Frederic Graff</h1><br>
...
<button onclick="addToCart('Reloj Frederic Graff de mujer (plata)', 1100, document.getElementById('quantity120').value)" class="wishlist">Añadir al carrito</button> <label for="quantity120">Cantidad: </label>
        <input type="number" id="quantity120" min="1" max="5" value="1"><br>
        <br>
