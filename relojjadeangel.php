...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojjadeangel.jpg" width="300"alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj Jade Angel</h1><br>
...
<button onclick="addToCart('Reloj Jade Angel de mujer (plata)', 1000, document.getElementById('quantity119').value)" class="wishlist">Añadir al carrito</button> <label for="quantity119">Cantidad: </label>
        <input type="number" id="quantity119" min="1" max="5" value="1"><br>
        <br>
