...
<section class="product-page">
        ...
        <div class="product-details" style=" width: 35%;
            ...
            <br>
            <button onclick="addToCart('Cadena de mariposa hueca (plata)', 300, document.getElementById('quantity19').value)" class="wishlist">Añadir al carrito</button> <label for="quantity19">Cantidad: </label>
        <input type="number" id="quantity19" min="1" max="10" value="1"><br>
        <br>
