...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodetrebol.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de Trébol</h1><br>
            <p class="price"><strong>Lps. 1,100 <span></span></strong></p><br>
...
<button onclick="addToCart('Anillo de Trébol (oro)', 1100, document.getElementById('quantity85').value)" class="wishlist">Añadir al carrito</button> <label for="quantity85">Cantidad: </label>
        <input type="number" id="quantity85" min="1" max="3" value="1"><br>
        <br>
