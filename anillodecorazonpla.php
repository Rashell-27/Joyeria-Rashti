...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodecorazonpla.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
...
<button onclick="addToCart('Anillo de corazón (plata)', 1600, document.getElementById('quantity98').value)" class="wishlist">Añadir al carrito</button> <label for="quantity98">Cantidad: </label>
