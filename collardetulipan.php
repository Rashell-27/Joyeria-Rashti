...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collardetulipan.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Collar de tulipan</h1><br>
            <p class="price"><strong>Lps. 310 <span></span></strong></p><br>
            ...
            <p><strong>Colores de tulipan disponibles:</strong> Rojo, Naranja, Amarillo, Verde, Azul, Morado, Rosa y Blanco</p><br>
...
<br>
          <button onclick="addToCart('Collar de tulipan (oro)', 310, document.getElementById('quantity10').value)" class="wishlist">Añadir al carrito</button> <label for="quantity10">Cantidad: </label>
        <input type="number" id="quantity10" min="1" max="10" value="1"><br>
        <br>
