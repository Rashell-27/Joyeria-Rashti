...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodecerza.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de cerezas</h1><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
           ...
           <p><strong>Colores de perlas disponibles:</strong> Rojo, Verde, Blanco y Negro.</p><br>
...
<button onclick="addToCart('Anillo de cerezas (perlas)', 85, document.getElementById('quantity106').value)" class="wishlist">Añadir al carrito</button> <label for="quantity106">Cantidad: </label>
        <input type="number" id="quantity106" min="1" max="3" value="1"><br>
        <br>
