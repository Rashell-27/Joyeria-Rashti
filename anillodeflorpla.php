...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodeflorpla.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de flor</h1><br>
...
<button onclick="addToCart('Anillo de flor (plata)', 1800, document.getElementById('quantity99').value)" class="wishlist">Añadir al carrito</button> <label for="quantity99">Cantidad: </label>
        <input type="number" id="quantity99" min="1" max="3" value="1"><br>
        <br>
