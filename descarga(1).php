...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/descarga (1).jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulsera de carita y flor</h1><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Colores de chaquiras disponibles:</strong> Rojo, Azul, Café, Negro, Naranja, Rosa, Verde, Morado, Transparente, Amarillo y Blanco.</p><br>
                     <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de Carita y Flor (chaquiras)', 85, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
