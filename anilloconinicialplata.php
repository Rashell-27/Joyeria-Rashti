...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anilloconinicialplata.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
        ...
        <div class="product-details" style="width: 30%; height: auto;">
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
           ...
           <p><strong>Iniciales disponibles:</strong> S, C, J y V</p>
           <br>
          <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
<button onclick="addToCart('Anillo con inicial (plata)', 1500, document.getElementById('quantity97').value)" class="wishlist">Añadir al carrito</button> <label for="quantity97">Cantidad: </label>
        <input type="number" id="quantity97" min="1" max="3" value="1"><br>
        <br>
