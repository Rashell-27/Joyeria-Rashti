...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojdeoronwestmujer2.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj nine west</h1><br>
            <p class="price"><strong>Lps. 900 <span></span></strong></p><br>
...
<button onclick="addToCart('Reloj nine west de mujer (oro)', 900, document.getElementById('quantity110').value)" class="wishlist">Añadir al carrito</button> <label for="quantity110">Cantidad: </label>
        <input type="number" id="quantity110" min="1" max="5" value="1"><br>
        <br>
