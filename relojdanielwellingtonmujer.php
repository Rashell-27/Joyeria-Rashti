...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojdanielwellingtonmujer.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj Daniel Wellington</h1><br>
            <p class="price"><strong>Lps. 1,600 <span></span></strong></p><br>
...
<button onclick="addToCart('Reloj Daniel Wellington de mujer (oro)', 1600, document.getElementById('quantity114').value)" class="wishlist">Añadir al carrito</button> <label for="quantity114">Cantidad: </label>
        <input type="number" id="quantity114" min="1" max="5" value="1"><br>
        <br>
