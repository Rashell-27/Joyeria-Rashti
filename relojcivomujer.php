...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojcivomujer.jpg" alt="Anillo de compromiso"  class="active">
...
<button onclick="addToCart('Reloj civo de mujer (oro)', 800, document.getElementById('quantity109').value)" class="wishlist">Añadir al carrito</button> <label for="quantity109">Cantidad: </label>
