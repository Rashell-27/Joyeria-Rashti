...
<section class="product-page">
        ...
        <div class="product-details"style="margin:auto; padding: 10PX;">
            ...
            <p><strong>Color de rosas disponibles:</strong> Rojo, Negro, Azul, Rosa, Café, <BR>Blanco, Verde y Morado.</p><br>
...
<br>
          <button onclick="addToCart('Gargantilla de rosas (oro)', 470, document.getElementById('quantity7').value)" class="wishlist">Añadir al carrito</button> <label for="quantity7">Cantidad: </label>
        <input type="number" id="quantity7" min="1" max="10" value="1"><br>
        <br>
