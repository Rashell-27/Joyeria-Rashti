...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojanalogicocauchomujer.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;" >
            <h1>Reloj analógico</h1><br>
            <p class="price"><strong>Lps. 700 <span></span></strong></p><br>
...
<button onclick="addToCart('Reloj analógico de mujer (caucho)', 700, document.getElementById('quantity123').value)" class="wishlist">Añadir al carrito</button> <label for="quantity123">Cantidad: </label>
        <input type="number" id="quantity123" min="1" max="5" value="1"><br>
        <br>
