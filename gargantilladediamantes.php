...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/gargantilladediamantes.jfif" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Gargantilla de diamantes</h1><br>
            <p class="price"><strong>Lps. 2,500 <span></span></strong></p><br>
...
<br>
<button onclick="addToCart('Gargantilla de diamantes (plata)', 2500, document.getElementById('quantity26').value)" class="wishlist">Añadir al carrito</button> <label for="quantity26">Cantidad: </label>
        <input type="number" id="quantity26" min="1" max="10" value="1"><br>
        <br>
