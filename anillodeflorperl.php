...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodeflorperl.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo con flor</h1><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
           ...
           <p><strong>Colores de flor disponibles:</strong> Rojo, Azul, Naranja, Morado, Rosa y Blanco.</p><br>
           <br>
          <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
<button onclick="addToCart('Anillo con flor (perlas)', 80, document.getElementById('quantity101').value)" class="wishlist">Añadir al carrito</button> <label for="quantity101">Cantidad: </label>
        <input type="number" id="quantity101" min="1" max="3" value="1"><br>
        <br>
