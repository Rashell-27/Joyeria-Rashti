...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulsefloresace1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details">
            <h1>Pulsera de Flores</h1><br>
            <p class="price"><strong>Lps. 130 <span></span></strong></p><br>
          ...
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de Flores (oro)', 130, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
