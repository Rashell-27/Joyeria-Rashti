...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojanalogicocivomujer.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj analógico civo</h1><br>
            <p class="price"><strong>Lps. 600 <span></span></strong></p><br>
...
<button onclick="addToCart('Reloj analógico civo de mujer (caucho)', 600, document.getElementById('quantity125').value)" class="wishlist">Añadir al carrito</button> <label for="quantity125">Cantidad: </label>
