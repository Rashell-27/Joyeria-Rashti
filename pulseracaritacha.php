...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulseracaritacha1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulsera de carita</h1><br>
            <p class="price"><strong>Lps. 50 c/u <span></span></strong></p><br>

          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Medidas para mujeres:</strong> 16.5cm, 18cm, 19cm, 20cm y 21cm</p><br>
            
            <p><strong>Colores de chaquiras disponibles:</strong> Rojo, Azul, Café, Negro, Naranja, Rosa, Verde, Morado, Amarillo y Blanco.</p><br>
            <p><strong>Colores de corazones disponibles:</strong> Rojo, Azul, Negro, Naranja, Rosa, Verde, Morado, y Amarillo.</p>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de Carita (chaquiras)', 50, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
            <input type="number" id="quantity41" min="1" max="10" value="1"><br>
            <br>
                    <a href="Pulserasmujer2.php" class="wishlist">Volver</a></button>
