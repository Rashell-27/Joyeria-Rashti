...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodeplatacondiamantes.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
...
<button onclick="addToCart('Anillo de diamante (plata)', 1500, document.getElementById('quantity93').value)" class="wishlist">Añadir al carrito</button> <label for="quantity93">Cantidad: </label>
        <input type="number" id="quantity93" min="1" max="3" value="1"><br>
        <br>
