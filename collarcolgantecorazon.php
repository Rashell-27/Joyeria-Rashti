...
<br>
<button onclick="addToCart('Collar de corazón (oro)', 450, document.getElementById('quantity6').value)" class="wishlist">Añadir al carrito</button> <label for="quantity6">Cantidad: </label>
        <input type="number" id="quantity6" min="1" max="10" value="1"><br>
        <br>
