...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anilloderosa.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de Rosa</h1><br>
...
<button onclick="addToCart('Anillo de Rosa (oro)', 1200, document.getElementById('quantity87').value)" class="wishlist">Añadir al carrito</button> <label for="quantity87">Cantidad: </label>
        <input type="number" id="quantity87" min="1" max="3" value="1"><br>
        <br>
