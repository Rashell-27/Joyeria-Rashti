...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/gargantillacondiamantespla.jfif" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Gargantilla con diamantes</h1><br>
            <p class="price"><strong>Lps. 1,700 <span></span></strong></p><br>
            <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Medidas disponibles:</strong> 30cm y 35 cm de largo</p><br>
...
<br>
<button onclick="addToCart('Gargantilla con diamantes (plata)', 1700, document.getElementById('quantity25').value)" class="wishlist">Añadir al carrito</button> <label for="quantity25">Cantidad: </label>
        <input type="number" id="quantity25" min="1" max="10" value="1"><br>
        <br>
