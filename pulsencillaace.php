...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulsencillaace1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details">
            <h1>Pulsera de Acero</h1><br>
            <p class="price"><strong>Lps. 100 <span></span></strong></p><br>
...
<button onclick="addToCart('Pulsera Sencilla (oro)', 100, document.getElementById('quantity42').value)" class="wishlist">Añadir al carrito</button> <label for="quantity42">Cantidad: </label>
        <input type="number" id="quantity42" min="1" max="10" value="1"><br>
        <br>
