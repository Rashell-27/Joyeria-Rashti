...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pul3perlasace1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details">
            <h1>Pulsera Decorada</h1><br>
            <p class="price"><strong>Lps. 115 <span></span></strong></p><br>
          ...
          <button onClick="addToCart('Pulsera Decorada (oro)', 115, document.getElementById('quantity43').value)" class="wishlist">Añadir al carrito</button> <label for="quantity43">Cantidad: </label>
