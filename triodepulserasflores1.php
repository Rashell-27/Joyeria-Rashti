...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulserarosaflor1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%;height: 105%;">
            <h1>Pulsera de flor</h1><br>
          ...
          <br>
          <p><strong>Colores de flores disponibles:</strong> Rojo, Azul, Negro, Rosa, Morado, Amarillo y Blanco.</p><br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de flor (perlas)', 85, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
