...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/Bae1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulsera con frases (cartoncillo)</h1><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Colores de cartoncillos disponibles:</strong> Blanco y Amarillo.</p>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera con frases + cartoncillo (chaquiras)', 90, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
