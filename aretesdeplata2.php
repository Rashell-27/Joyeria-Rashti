...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/aretesdemariplata.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Aritos de mariposa</h1><br>
            <p class="price"><strong>Lps. 1,100 <span></span></strong></p><br>
            
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Tallas disponibles:</strong> 15mm, 20mm, 30mm y 35mm. </p><br>
                      <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
            <button onclick="addToCart('Aritos de Mariposa (plata)', 1100, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
