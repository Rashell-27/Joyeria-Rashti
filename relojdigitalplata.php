...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojdigitalplata.jpg" width="300" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj Digital</h1><br>
...
<button onclick="addToCart('Reloj digital de mujer (plata)', 800, document.getElementById('quantity117').value)" class="wishlist">Añadir al carrito</button> <label for="quantity117">Cantidad: </label>
        <input type="number" id="quantity117" min="1" max="5" value="1"><br>
        <br>
