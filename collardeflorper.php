...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collardeflorper.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details"style="width: 35%;
            height: 100%">
            <h1>Collar de flores</h1><br>
            ...
            <p><strong>Colores de flor disponibles:</strong> Rosa, Amarillo y Blanco.</p><br>
