...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillofloredediamanmte.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de flor de diamante</h1><br>
            <p class="price"><strong>Lps. 2,400 <span></span></strong></p><br>
...
<button onclick="addToCart('Anillo de flor de diamante (oro)', 2400, document.getElementById('quantity89').value)" class="wishlist">Añadir al carrito</button> <label for="quantity89">Cantidad: </label>
        <input type="number" id="quantity89" min="1" max="3" value="1"><br>
        <br>
