...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojcorreadecorazonplata.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj con correa de corazón</h1><br>
...
<button onclick="addToCart('Reloj con correa de corazón (plata)', 750, document.getElementById('quantity115').value)" class="wishlist">Añadir al carrito</button> <label for="quantity115">Cantidad: </label>
        <input type="number" id="quantity115" min="1" max="5" value="1"><br>
        <br>
