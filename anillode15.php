...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillode15.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de 15 años</h1><br>
            <p class="price"><strong><del>Lps. 3,800 </del><span></span></strong></p><br>
...
<button onclick="addToCart('Anillo de 15 años (oro)', 3230, document.getElementById('quantity88').value)" class="wishlist">Añadir al carrito</button> <label for="quantity88">Cantidad: </label>
        <input type="number" id="quantity88" min="1" max="3" value="1"><br>
        <br>
        <button > <a href="Interfaz de ofertas.php" class="wishlist">Comprar descuento</a>
