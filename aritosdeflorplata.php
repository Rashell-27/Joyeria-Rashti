...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/aritosdeflorplata.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Aritos de flor</h1><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <button onClick="addToCart('Aritos de flor (plata)', 800, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
