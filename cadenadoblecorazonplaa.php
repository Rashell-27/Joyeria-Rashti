...
<section class="product-page">
        ...
        <div class="product-details" style=" width: 35%;
            ...
            <br>
            <button onclick="addToCart('Cadena Doble (plata)', 480, document.getElementById('quantity18').value)" class="wishlist">Añadir al carrito</button> <label for="quantity18">Cantidad: </label>
