...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodecorazonhueco.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de corazón hueco</h1><br>
            <p class="price"><strong>Lps. 1,000 <span></span></strong></p><br>
...
<button onclick="addToCart('Anillo de corazón hueco (oro)', 1000, document.getElementById('quantity89').value)" class="wishlist">Añadir al carrito</button> <label for="quantity89">Cantidad: </label>
