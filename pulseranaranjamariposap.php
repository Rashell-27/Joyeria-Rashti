...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulseranaranjamariposap.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style= " height: 105%; width: 30%;" >
            <h1>Pulsera de Mariposa</h1><br>
            <p class="price"><strong>Lps. 95 <span></span></strong></p><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Colores de mariposa disponibles:</strong> Rojo, Azul, Negro, Naranja, Rosa, Morado y Blanco.</p>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de Mariposa (perlas)', 95, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
