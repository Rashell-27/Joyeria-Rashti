...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodecorona.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de corona</h1><br>
...
<button onclick="addToCart('Anillo de corona (oro)', 1800, document.getElementById('quantity90').value)" class="wishlist">Añadir al carrito</button> <label for="quantity90">Cantidad: </label>
        <input type="number" id="quantity90" min="1" max="3" value="1"><br>
        <br>
        <a href="Interfaz de ofertas.php" class="wishlist">Ver Ofertas</a>
