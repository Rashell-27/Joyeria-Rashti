...
<section class="product-page">
        <div class="product-images" >
            <img src="imagenes/gargantillacolganteperla.jpg" alt="Anillo de compromiso" class="active" tyle="width: 35%;
            height: 110%">
       
        </div>

        <div class="product-details"tyle="width: 35%;
        height: 110%">
            <h1>Gargantilla con colgante</h1><br>
