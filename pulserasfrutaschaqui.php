...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulserasfrutaschaqui1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulsera de frutas</h1><br>
            <p class="price"><strong>Lps. 60 <span></span></strong></p><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Frutas disponibles:</strong> Uva, piña, manzana roja, limón, toronja y naranja.</p>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de frutas (chaquiras)', 60, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
