...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojxoxomujer.jpg" alt="Anillo de compromiso"  class="active">
...
<button onclick="addToCart('Reloj xoxo de mujer (oro)', 1000, document.getElementById('quantity111').value)" class="wishlist">Añadir al carrito</button> <label for="quantity111">Cantidad: </label>
        <input type="number" id="quantity111" min="1" max="5" value="1"><br>
        <br>
