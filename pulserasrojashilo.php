...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulserasrojashilo1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulsera con iniciales Doradas</h1><br>
            <p class="price"><strong>Lps. 50 <span></span></strong></p><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Iniciales disponibles:</strong> Todas.</p>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera con iniciales Doradas (hilo)', 50, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
