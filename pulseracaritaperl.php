...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulseracaritaperl.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
        ...
        <div class="product-details">
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Colores de perlas disponibles:</strong> Negro y Blanco.</p><br>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de Carita (perlas)', 70, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
