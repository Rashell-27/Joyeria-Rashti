...
<br>
<button onclick="addToCart('Collar Curvilineo (plata)', 650, document.getElementById('quantity22').value)" class="wishlist">Añadir al carrito</button> <label for="quantity22">Cantidad: </label>
        <input type="number" id="quantity22" min="1" max="10" value="1"><br>
        <br>
