...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/7nudoshilo.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulsera de 7 nudos</h1><br>
            <p class="price"><strong>Lps. 35 <span></span></strong></p><br>
          ...
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de 7 nudos (hilo)', 35, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
