...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojsmarwatchredondomujer.jpg" width="400" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Smartwatch redondo</h1><br>
            <p class="price"><strong>Lps. 2100 <span></span></strong></p><br>
            
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Tallas disponibles:</strong> 15cm y 17cm</p><br>
           <p><strong>Colores disponibles:</strong> Negro, Azul, Rosa, Rojo, Morado y Blanco.</p><br>
           <br>
          <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
<button onclick="addToCart('Smart Watch de mujer redondo (caucho)', 2100, document.getElementById('quantity126').value)" class="wishlist">Añadir al carrito</button> <label for="quantity126">Cantidad: </label>
        <input type="number" id="quantity126" min="1" max="5" value="1"><br>
        <br>
