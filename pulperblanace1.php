...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulperblanace1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details">
            <h1>Pulsera Decorada</h1><br>
            <p class="price"><strong>Lps. 140 <span></span></strong></p><br>
          ...
          <button onclick="addToCart('Pulsera Decorada (oro)', 140, document.getElementById('quantity43').value)" class="wishlist">Añadir al carrito</button> <label for="quantity43">Cantidad: </label>
        <input type="number" id="quantity43" min="1" max="10" value="1"><br>
        <br>
        <a href="Interfaz de ofertas.php" class="wishlist">Ir a Oferta</a>
