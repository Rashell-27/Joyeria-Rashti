...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/gargantillaconinicialperl.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details"style="width: 35%;
            height: 100%">
            <h1>Gargantilla con inicial personalizada</h1><br>
            <p class="price"><strong>Lps. 230 <span></span></strong></p><br>
