...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collardegomitas.jpg" alt="Anillo de compromiso" width="765" height="528" class="active">
       
        </div>

        <div class="product-details" style="width: 35%;
            height: 100%" >
            <h1>Collar de gomitas</h1><br>
          ...
          <p><strong>Colores de gomita disponibles:</strong> Azul, Rosa, Blanco, Amarillo y Verde.</p><br>
