...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojninewsstplata.jpg" alt="Anillo de compromiso"  class="active">
...
<button onclick="addToCart('Reloj nine west de mujer (plata)', 900, document.getElementById('quantity118').value)" class="wishlist">Añadir al carrito</button> <label for="quantity118">Cantidad: </label>
