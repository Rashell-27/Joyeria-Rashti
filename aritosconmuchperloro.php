...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/aritosconmuchperlcoloro.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Aritos con perlas colgantes</h1><br>
            <p class="price"><strong>Lps. 2,000 <span></span></strong></p><br>
            
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Tallas disponibles:</strong> 10mm. </p><br>
            <p><strong>Colores de perlas disponibles:</strong> Blanco, Rojo, Verde, Azul y Negro. </p><br>
           <br>
          <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
            <button onclick="addToCart('Aritos con perlas colgantes (oro)', 2000, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
            <input type="number" id="quantity41" min="1" max="10" value="1"><br>
            <br>
                    <a href="aritos.php" class="wishlist">Volver</a></button>
