...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/relojlaurashleymujer.jpg" alt="Anillo de compromiso"  class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Reloj Laura Ashley</h1><br>
...
<button onclick="addToCart('Reloj Laura Ashley (oro)', 1500, document.getElementById('quantity113').value)" class="wishlist">Añadir al carrito</button> <label for="quantity113">Cantidad: </label>
        <input type="number" id="quantity113" min="1" max="5" value="1"><br>
        <br>
