...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulcorazonyperlashilo.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulsera de hilo con perlas</h1><br>
            <p class="price"><strong>Lps. 80 c/u <span></span></strong></p><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Colores de perlas disponibles:</strong> Dorado, Rosa, Azul, Verde, Amarillo, Naranja, Blanco, Negro y Rojo</p><br>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de Trebol(oro)', 120, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
