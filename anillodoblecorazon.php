...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodoblecorazón.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de doble Corazón</h1><br>
...
<button onclick="addToCart('Anillo de doble corazón (oro)', 2500, document.getElementById('quantity91').value)" class="wishlist">Añadir al carrito</button> <label for="quantity91">Cantidad: </label>
