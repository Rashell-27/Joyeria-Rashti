...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anilloestrella.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de estrella</h1><br>
            <p class="price"><strong>Lps. 80 <span></span></strong></p><br>
            
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Tallas disponibles:</strong> 4, 6, 7, 8, 9 y 10</p><br>
           <p><strong>Colores de perlas disponibles:</strong> Rojo, Azul, Verde, Amarillo, Naranja, Morado, Rosa, Blanco y Negro.</p><br>
           <p><strong>Colores de estrella disponibles:</strong> Rojo, Azul, Verde, Amarillo, Blanco y Negro.</p><br>
           <br>
          <h2>Formas de pago:</h2>
            <ul>
                <li>Pago en efectivo 💵</li>
            </ul>
<button onclick="addToCart('Anillo de estrella (perlas)', 80, document.getElementById('quantity104').value)" class="wishlist">Añadir al carrito</button> <label for="quantity104">Cantidad: </label>
        <input type="number" id="quantity104" min="1" max="3" value="1"><br>
        <br>
