...
<section class="product-page">
        <div class="product-images"  style="width: 650px; height: 500px;">
            <img src="imagenes/ofertas/WhatsApp Image 2024-10-21 at 2.17.10 PM (3).jpeg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Oferta del 15%</h1><br>
            <span class="price"><del>Lps.5,200</del></span>
            <p class="price"><strong>Lps. 4,420 <span></span></strong></p><br>
            
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p>Por la compra de estos 3 productos podrás llevarte el 15% de descuento del precio total a diferencia de comprar el set separado.</p><br>
...
<button onclick="addToCart('Set de quinceañera', 4420, document.getElementById('quantity95').value)" class="wishlist">Añadir al carrito</button> <label for="quantity95">Cantidad: </label>
