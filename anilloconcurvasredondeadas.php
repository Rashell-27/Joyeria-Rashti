...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anilloconcurvasredondeadas.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de diamantes</h1><br>
...
<button onclick="addToCart('Anillo de diamantes grueso (oro)', 2500, document.getElementById('quantity92').value)" class="wishlist">Añadir al carrito</button> <label for="quantity92">Cantidad: </label>
        <input type="number" id="quantity92" min="1" max="3" value="1"><br>
        <br>
