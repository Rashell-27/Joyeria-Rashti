...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulalmejaper.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details">
            <h1>Pulsera de Almeja</h1><br>
            <p class="price"><strong>Lps. 105 <span></span></strong></p><br>
          ...
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de Almeja (perlas)', 105, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
