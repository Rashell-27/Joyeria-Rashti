...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collardecruz1.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details">
            <h1>Cadena de cruz</h1><br>
            <p class="price"><strong>Lps. 300 <span></span></strong></p><br>
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            <p><strong>Medidas disponibles:</strong> 45cm, 50cm y 55cm de largo.</p><br>
          <br>
...
<button onclick="addToCart('Cadena de cruz (oro)', 300, document.getElementById('quantity2').value)" class="wishlist">Añadir al carrito</button> <label for="quantity2">Cantidad: </label>
