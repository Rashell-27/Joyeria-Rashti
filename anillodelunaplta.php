...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anillodelunaplata.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo de luna</h1><br>
            <p class="price"><strong><del>Lps. 1,100 </del><span></span></strong></p><br>
            <p class="price">Lps.935</p>
...
<button onclick="addToCart('Anillo de luna (plata)', 935, document.getElementById('quantity96').value)" class="wishlist">Añadir al carrito</button> <label for="quantity96">Cantidad: </label>
        <input type="number" id="quantity96" min="1" max="3" value="1"><br>
        <br>
