...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collardemariposaoro.jpg" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details">
            <h1>Collar de mariposa</h1><br>
            <p class="price"><strong>Lps. 320 <span></span></strong></p><br>
...
<br>
<button onclick="addToCart('Collar de mariposa (oro)', 320, document.getElementById('quantity10').value)" class="wishlist">Añadir al carrito</button> <label for="quantity10">Cantidad: </label>
