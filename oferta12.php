...
<section class="product-page">
        <div class="product-images"  style="width: 650px; height: 500px;">
            <img src="imagenes/ofertas/WhatsApp Image 2024-10-21 at 2.17.09 PM (3).jpeg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Oferta del 15%</h1><br>
            <p class="price"><strong><del>Lps.1,100</del><br>Lps.935 <span></span></strong></p><br>
...
<button onclick="addToCart('Anillo de luna descuento (plata)', 935, document.getElementById('quantity95').value)" class="wishlist">Añadir al carrito</button> <label for="quantity95">Cantidad: </label>
