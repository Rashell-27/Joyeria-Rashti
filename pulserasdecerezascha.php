...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulserasdecerezacha.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulseras de Cereza</h1><br>
            ...
            <p><strong>Colores de chaquiras disponibles:</strong> Rojo, Negro, Verde y Blanco.</p><br>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera de cereza (chaquiras)', 55, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
