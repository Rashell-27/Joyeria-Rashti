...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/pulinicialacej.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details">
            <h1>Pulsera con Inicial</h1><br>
            <p class="price"><strong>Lps. 145<span></span></strong></p><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Letras disponibles:</strong> Todas.</p><br>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera con inicial (oro)', 145, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
