...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collardeperlassencillo.jfif" alt="Anillo de compromiso" class="active">
        ...
        <div class="product-details"    style="width: 35%;
            ...
            <p class="price"><strong>Lps. 170 <span></span></strong></p><br>
            ...
            <p><strong>Colores de perlas disponibles:</strong> Rojo, Azul, Café, Negro, Naranja, Rosa, Verde, Morado, Amarillo, Dorado y Blanco.</p><br>
