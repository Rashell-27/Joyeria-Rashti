...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/collardelunapla.jfif" alt="Anillo de compromiso" class="active">
       
        </div>

        <div class="product-details" style=" width: 35%;
            height: 95%">
            <h1>Cadena de luna</h1><br>
...
<br>
<button onclick="addToCart('Cadena de luna (plata)', 480, document.getElementById('quantity14').value)" class="wishlist">Añadir al carrito</button> <label for="quantity14">Cantidad: </label>
        <input type="number" id="quantity14" min="1" max="10" value="1"><br>
        <br>
