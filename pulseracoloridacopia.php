...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/Pulseracoloridacopia.jpg" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Pulsera Blanca decorada</h1><br>
            <p class="price"><strong>Lps. 75 <span></span></strong></p><br>
          ...
          <p class="acerca"><strong>Acerca del producto:</strong></p><br>
            ...
            <p><strong>Colores de fimo disponibles:</strong> Rojo, Azul, Café, Negro, Naranja, Rosa, Verde, Morado, Amarillo y Blanco.</p><br>
            <p><font color="red"> Esta pulsera no tiene otro color de perlas disponibles aparte de blanco.</font></p>
          <br>
          <h2>Formas de pago:</h2>
            ...
            <button onclick="addToCart('Pulsera Blanca decorada (perlas)', 75, document.getElementById('quantity41').value)" class="wishlist">Añadir al carrito</button> <label for="quantity41">Cantidad: </label>
