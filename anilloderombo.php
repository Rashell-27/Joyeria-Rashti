...
<section class="product-page">
        <div class="product-images">
            <img src="imagenes/anilloderombo.jfif" alt="Anillo de compromiso" width="707" height="523" class="active">
       
        </div>

        <div class="product-details" style="width: 30%; height: auto;">
            <h1>Anillo con rombo de diamante</h1><br>
...
<button onclick="addToCart('Anillo con rombo de diamante (oro)', 2500, document.getElementById('quantity90').value)" class="wishlist">Añadir al carrito</button> <label for="quantity90">Cantidad: </label>
